...
(function () {
    ...
    tabConnector.getSchema = function(schemaCallback) {
      ...
      var raceCols = [
        { id: "season", dataType: tableau.dataTypeEnum.int },
        { id: "round", dataType: tableau.dataTypeEnum.int },
        { id: "raceName", dataType: tableau.dataTypeEnum.string },
        { id: "circuitName", dataType: tableau.dataTypeEnum.string },
        { id: "lat", alias: "latitude", dataType: tableau.dataTypeEnum.float },
        { id: "long", alias: "longitude", dataType: tableau.dataTypeEnum.float },
      ...
      var resCols = [
        { id: "season", dataType: tableau.dataTypeEnum.int },
        { id: "round", dataType: tableau.dataTypeEnum.int },
        { id: "number", alias: "Driver Number", dataType: tableau.dataTypeEnum.int },
    ...
    tabConnector.getData = function (table, doneCallback) {
      ...
      var sobj = JSON.parse(tableau.connectionData), syr = sobj.startSeason, eyr = sobj.endSeason;
          ...
          for (var i = 0, len = races.length; i < len; i++) {
            if (table.tableInfo.id == "f1races") {
              tableData.push({
                ...
                "long": races[i].Circuit.Location.long,
